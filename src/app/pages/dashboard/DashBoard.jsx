          ...
          <Card style={{borderRadius:" 0.5rem"}}>
            <Row type="flex" justify="space-around" align="middle">
              ...
              <Col flex="auto" offset={2}>
                <PlusSquareOutlined   style={{ fontSize: "20px", color:"#95aac9"}}/>
              </Col>
            </Row>
          </Card>
        </Col>
        <Col span={12}   xs={24}  sm={12} md={6} lg={6}>
          <Card style={{borderRadius:" 0.5rem"}}>
            <Row type="flex" justify="space-around" align="middle">
              ...
              <Col flex="auto" offset={2}>
                <VideoCameraOutlined   style={{ fontSize: "20px", color:"#95aac9"}}/>
              </Col>
            </Row>
          </Card>
        </Col>
        <Col span={12}   xs={24}  sm={12} md={6} lg={6}>
          <Card style={{borderRadius:" 0.5rem"}}>
            <Row type="flex" justify="space-around" align="middle">
              ...
              <Col flex="auto" offset={2}>
                <CopyOutlined   style={{ fontSize: "20px", color:"#95aac9"}}/>
              </Col>
            </Row>
          </Card>
        </Col>
        <Col span={12}   xs={24}  sm={12} md={6} lg={6}>
          <Card style={{borderRadius:" 0.5rem"}}>
            <Row type="flex" justify="space-around" align="middle">
              ...
              <Col flex="auto" offset={2}>
                <CheckSquareOutlined   style={{ fontSize: "20px", color:"#95aac9"}}/>
              </Col>
            </Row>
          </Card>
        </Col>
