  ...
  return (
    <article>
      ...
      <ul>
        ...
        <li>After answering all questions please submit with "Submit" button.</li>
        <li className="my-4">After clicking the submit button, you can see your exam result.</li>
      ...
      <ul>
        <li>You have to watch the video from start to end without forward. Othrwise the video'll be marked as unwatched.</li>
      </ul>
    </article>
  );
};
