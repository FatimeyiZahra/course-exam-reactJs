        ...
        <table className="table table-sm card-table">
          <tbody className="list font-size-sm">
            ...
            <tr className="d-none d-lg-table-row">
              ...
              <td>
                Safety Management System Online Course starts with definitions
                and Basic Parts of an SMS Program which are Organizational
                Commitment, Safety Organization and Planning, Provision for
                Compliance with Legal and Regulatory. The course then focuses on
                Procedures and Control, Safety Risk Management Procedures,
                Safety Policy, Staff Reporting and Responsibilities. A short
                summary is presented for you at the end of the course.{" "}
              </td>
            </tr>
            <tr>
              <th>Course Files</th>
